...
function ArcaneSigil() {
  return (
    <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" className="arcane-bg" aria-hidden>
  ...
  return (
    <div className="app-shell">
      ...
      <header className="app-header">
        ...
        <div className="header-eyebrow">The Arcane Forge</div>
        <h1 className="header-title">Magic Grimoire</h1>
        <p className="header-subtitle">Speak your desire — the cards shall answer</p>
      </header>
